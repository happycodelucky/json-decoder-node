...
// class AliasExamples {
//     // Use property name as key name, convert to Number
//     @jsonPropertyAlias('simple') public readonly simple: String

//     @jsonPropertyAlias('nested.simple') public readonly nestedSimple: String

//     @jsonPropertyAlias('nested.array@1', String)
//     public readonly nestedArrayAt1: String

//     @jsonPropertyAlias('nested.doubleNested') public readonly doubleNestedSimpleObject: Object

//     @jsonPropertyAlias('nested.doubleNested.simpleNumber') public readonly doubleNestedSimpleNumber: Number
// }
...
//     @jsonPropertyAlias('values', [Number], (values: Array<number>) =>
//         values.map((value) => `0x${value.toString(16).toUpperCase()}`)
//     )
//     public readonly base16String: Array<string>

//     // Alias with map function, which actually a reduce
//     @jsonPropertyAlias('values', [Number], (values: Array<number>) =>
//         values.reduce((value, acc) => {
//             return acc + value
//         }, 0)
//     )
...
//     @jsonPropertyAlias('welcome', String, (value: string) =>
//         value
//             .split('')
//             .reverse()
//             .join('')
