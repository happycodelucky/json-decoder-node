import { JsonDecoder, jsonDecodable, jsonPropertyAlias, jsonSchema, jsonProperty } from '../src'
...
//     @jsonRequired('\'{{name}}\' is required')
//     @jsonMinItems(1, '\'{{name}}\ should only contain 1 element')
//     @jsonMaxItems(30)
//     @jsonPattern(/xx/, '')
//     @jsonUniqueItems()
//     @jsonSchema({
...
//     "test": ["2", true]
// }
// const account = JsonDecoder.decode(json, Test)
// if (account) {
